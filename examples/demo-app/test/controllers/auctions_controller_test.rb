...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { amount: @auction.amount, bid: @auction.bid, bidder: @auction.bidder, item_id: @auction.item_id } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { amount: @auction.amount, bid: @auction.bid, bidder: @auction.bidder, item_id: @auction.item_id } }
